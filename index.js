      ...
      switch(c){
        ...
        case Map:
          ...
          for(c of a){
            ...
            if(m[1] !== c[1] && !qcompare(c[1],m[1]))return false;
          }
          return true;
        case Set:
          ...
          for(v of a){
            h = r.next().value;
            if(h !== v && !qcompare(v,h))return false;
          }
          return true;
        case RegExp:
        ...
        case undefined:
          let u,y = 0;
          for(u in a){
            if(!(u in b) || !qcompare(a[u],b[u]))return false;
            y++;
          }
